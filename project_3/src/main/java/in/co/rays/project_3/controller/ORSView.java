...
public interface ORSView {
	...
	public String PURCHASE_ORDER_CTL = APP_CONTEXT + "/ctl/PurchaseOrderCtl";
	public String PURCHASE_ORDER_LIST_CTL = APP_CONTEXT + "/ctl/PurchaseOrderCtl";
	public String PURCHASE_ORDER_VIEW = PAGE_FOLDER + "/PurchaseOrderView.jsp";
	public String PURCHASE_ORDER_LIST_VIEW = PAGE_FOLDER + "/PurchaseOrderView.jsp";
